...
class TrafikForm(ModelForm):
    class Meta:
        ...
        fields = ('sigortali', 'arac_plaka', 'belge_seri_no', 'kullanim_tarzi', 'arac_marka', 'arac_tipi', 'model_yili',
        ...
        widgets = {
            ...
            'model_yili': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Model Yılı'}),
            'arac_faturali': forms.Select(attrs={'class': 'form-control select2 select2-hidden-accessible',
                                                 'style': 'width: 100%;'}),
            'fatura_tarihi': forms.DateInput(attrs={'class': 'form-control  pull-right', 'id': 'datepicker'}),
            'arac_bedeli': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Araç Bedeli'}),
            ...
            'koltuk_sayisi': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Koltuk Sayısı'}),
            'tescil_tarihi': forms.DateInput(attrs={'class': 'form-control  pull-right', 'id': 'datepicker'}),
            'sigortali': forms.Select(attrs={'class': 'form-control select2 select2-hidden-accessible',
                                             'style': 'width: 100%;'}),
        }
