...
class KaskoSigortasi(models.Model):
    ...
    belge_seri_no = models.CharField(max_length=120,null=True,verbose_name='Belge Seri No')
    kullanim_tarzi = models.CharField(max_length=128,null=True,verbose_name='Kullanım Tarzı')
    ...
    arac_faturali = models.CharField(max_length=128,null=True, verbose_name='Araç Faturalı mı', choices=fatura_choices, default=NO)
